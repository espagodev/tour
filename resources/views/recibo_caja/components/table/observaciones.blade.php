        ...
        <div class="table-responsive">
            <table class="table table-hover table-sm" id="observaciones">
                <thead>
                    <tr>
                        <th>Observaciones</th>                                   
                        <th>Opciones <a  class="btn-modal" href="#" data-container=".view_register" data-href="{{ route('getMovimientoObservacion', [$facturaId, $factura->id]) }}"   data-container="body" data-bs-toggle="popover" data-placement="top" title="" data-original-title="Learning"><i data-feather="plus-square"></i></a></th>
                    </tr>
                </thead>
                <tbody>
