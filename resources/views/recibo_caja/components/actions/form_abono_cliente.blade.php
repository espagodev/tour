<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title" id="myLargeModalLabel">Pago Recibo Baja ({{ $factura->fac_recibo }})</h4>
            <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <form class="row g-3 needs-validation" action="{{ route('storeAbonoReciboCaja') }}" method="post" novalidate="" id="quick_add_product_form" >
            @csrf
            <div class="modal-body">
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label class="form-label" for="moc_monto">Monto Total Pendiente</label>
            ...
            <div class="modal-footer">
                ...
                {{-- <a href="#" data-href="{{route('storeAbonoCliente')}}" class="abono_cliente btn btn-primary" >Guardar</a> --}}
