<div class="bookmark">
    <ul>
        ...
        <li>
            <a  class="btn-modal" href="#" data-container=".view_register_abono" data-href="{{ route('getAbonoReciboCaja', [$facturaId]) }}"   data-container="body" data-bs-toggle="popover" data-placement="top" title="" data-original-title="Learning"><i data-feather="dollar-sign"></i></a>
        </li>
          
      @endif
      <li><a href="{{ route('getFirmaRecibo', [$facturaId]) }}" data-container="body" data-bs-toggle="popover" data-placement="top"
        title="" data-original-title="Learning"><i data-feather="italic"></i></a>
        </li>
       
        <li><a href="{{ route('showReciboCaja', $facturaId) }}" data-container="body" data-bs-toggle="popover"
            data-placement="top" title="" data-original-title="Learning"><i
                data-feather="external-link"></i></a>
        </li>
        <li><a href="{{ route('viewReciboCaja', $facturaId) }}" data-container="body" data-bs-toggle="popover" data-placement="top"
            title="" data-original-title="Learning"><i data-feather="eye"></i></a>
        </li>
        <li><a href="{{ route('expedienteReciboCaja', $facturaId) }}" data-container="body" data-bs-toggle="popover" data-placement="top"
                title="" data-original-title="Learning"><i data-feather="file-text"></i></a>
        </li>

        
        <li><a href="{{ route('pdf.recibo_caja', [$factura->id, 'download' => true]) }}" target="_blank"  title=""
