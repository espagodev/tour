            ...
            <table class="table table-hover table-sm" id="pago_clientes">
                <thead>
                    <tr>
                        ...
                        <th>Fecha</th>
                        <th>Descripcion</th>
                        <th>Opciones <a  class="btn-modal" href="#" data-container=".view_register_abono" data-href="{{ route('getAbonoCliente', [$facturaId, $billetePlazo->billetes_plazos_id]) }}"   data-container="body" data-bs-toggle="popover" data-placement="top" title="" data-original-title="Learning"><i data-feather="plus-square"></i></a></th>
