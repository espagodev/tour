<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-hover table-xs" id="pago_mayorista">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Monto</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> <span class="display_currency" data-orig-value="{{ $abonoMayorista->moc_monto }}" data-currency_symbol = true>{{ $abonoMayorista->moc_monto }}</span></td>
