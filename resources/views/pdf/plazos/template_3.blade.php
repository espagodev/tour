...
<body>
        ...
        <table class="text-sm" width="100%">
            <tr>
                <td align="left" style="width: 40%;">
                    {{-- <h1 class="m-0" >{{$empresa->aje_nombre}}</h1> --}}
    ...
    <div class="invoice">
        <div class="grid">
            <div class="col">
                <span class="address text-sm">
                    <p class="mb-0"><strong>{{ $billetePlazo->full_name_agenda }}</strong></p>
                    <p class="mb-0">{{ $billetePlazo->documento }}</p>
                    <p class="mb-0">{{ $billetePlazo->agd_direccion }}</p>  
                    <p class="mb-0">{{ $billetePlazo->agd_telefono }}</p>
                    <p class="mb-0">{{ $billetePlazo->agd_email }}</p>
                </span>
            </div>
           
            <div class="col">
                <h5 class="text-sm">Billete a Plazo: <span class="fw-normal">{{$billetePlazo->fac_nota_credito}}</span></h5>
                <h5 class="text-sm">Fecha billetePlazo : <span class="fw-normal">{{$billetePlazo->created_at}}</span></h5>
                <h5 class="text-sm">Fecha Vencimiento: <span class="fw-normal">{{$billetePlazo->created_at}}</span></h5>
                <h5 class="text-sm">Atendido Por: <span class="fw-normal">{{$billetePlazo->full_name_agente }}</span></h5>
                <h5 class="text-sm">Forma de Pago: <span class="fw-normal">{{$billetePlazo->fop_nombre }}</span></h5>
        ...
        <div class="grid">           
            <div class="col">
                @include('pdf.plazos._table_pagos')       
            </div>
        </div>
