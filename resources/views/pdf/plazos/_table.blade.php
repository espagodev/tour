            ...
            <td>
                <table class="text-right sumtable" width="100%">
                    <tr>
                        ...
                        <td><p class="text-sm text-dark m-3"> @format_currency($billetePlazo->fac_total)</p></td>
                    </tr>
                    <tr>
                        <td><h4 class="text-sm text-dark text-left m-3">IVA</h4></td>
                        <td><p class="text-sm text-dark m-3">@format_currency($billetePlazo->fac_total_fee * 0.21)</p></td>
                    </tr>
                    <tr>
                        <td><h4 class="text-sm text-dark text-left m-3">Descuento</h4></td>
                        <td><p class="text-sm text-dark m-3">@format_currency($billetePlazo->fac_total_descuento)</p></td>
                    </tr>
                    <tr>
                        <td><h4 class="text-sm text-dark text-left m-3">Total</h4></td>
                        <td><p class="text-sm text-dark m-3">@format_currency($billetePlazo->fac_total + $billetePlazo->fac_total_fee)</p></td>
                    </tr>
                    @if ($billetePlazo->fac_total_pendiente > 0)
                        <tr>
                            <td><h4 class="text-sm text-dark text-left m-3">Total Pendiente</h4></td>
                            <td><p class="text-sm text-dark m-3">@format_currency($billetePlazo->fac_total_pendiente)</p></td>
                        </tr>
                    @endif
                </table>
            </td>            
