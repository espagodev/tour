$(document).ready(function () {
    ...
    $("#listado_ajustes, #forma_pago_id").change(function () {
        listado_ajustes.ajax.reload();
    });


    //listado de gastos
    listado_ajustes = $("#listado_ajustes").DataTable({ 
        processing: true,
        serverSide: true,
        aaSorting: false,
        searching: false,
        ajax: {
            url: "/ajusteContable/getListadoAjustes",
            dataType: "json",
            data: function (d) {
        ...
        fnDrawCallback: function (oSettings) {
            __currency_convert_recursively($("#listado_ajustes"));
        },
