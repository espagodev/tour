$(document).ready(function () { 
    ...
    $("#listado_gastos, #forma_pago_id").change(function () {
        listado_gastos.ajax.reload();
    });


    //listado de gastos
    listado_gastos = $("#listado_gastos").DataTable({ 
        processing: true,
        serverSide: true,
        aaSorting: false,
        searching: false,
        ajax: {
            url: "/gastos/getListadoGastos",
            dataType: "json",
            data: function (d) {
        ...
        fnDrawCallback: function (oSettings) {
            __currency_convert_recursively($("#listado_gastos"));
        },
