...
class GastosUtils
{
    ...
    public static function newGasto(Request $request)
    {
        $gasto = new MovimientoContable();

        // Fill model with old input
        if (!empty($request->old())) {
            $gasto->fill($request->old());
        }

        return $gasto;
    }

    public static function gastos($request)
    {
        $query = DB::table('movimiento_contables')
            ...
            ->where('movimiento_contables.moc_contable', '3')
            ;
    ...
    public static function gastoId($Id)
    {
    ...
    public static function gastoEditId($Id)
    {
