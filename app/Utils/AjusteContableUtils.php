...
class AjusteContableUtils
{

    public static function newAjusteContable(Request $request)
    {
        $ajusteContable = new MovimientoContable();

        // Fill model with old input
        if (!empty($request->old())) {
            $ajusteContable->fill($request->old());
        }

        return $ajusteContable;
    }

    public static function ajusteContables($request)
    {
        $query = DB::table('movimiento_contables')
            ...
            ->where('movimiento_contables.moc_contable', '5')
            ;
    ...
    public static function ajusteContableId($Id)
    {
    ...
    public static function ajusteContableEditId($Id)
    {
